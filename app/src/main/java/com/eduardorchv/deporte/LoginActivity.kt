...
class LoginActivity : AppCompatActivity() {
    ...
    //se añade paga entrar sesion a google
    private val callbackManager = CallbackManager.Factory.create()
    //se añade para entrar sesion a google
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == RESULT_CODE_GOOGLE_SIGN_IN) {
            try {
                ...
                Toast.makeText(this, "Error en la conexion con Google paso", Toast.LENGTH_SHORT).show()
            }
        }
    }

//se añade para facebook
